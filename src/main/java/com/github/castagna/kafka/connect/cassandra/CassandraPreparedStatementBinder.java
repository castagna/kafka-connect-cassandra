...
public class CassandraPreparedStatementBinder {
  ...
  public CassandraPreparedStatementBinder(
      PreparedStatement statement,
      CassandraSinkConnectorConfig.PrimaryKeyMode pkMode,
  ...
  static void bindField(PreparedStatement preparedStatement, int index, Schema schema, Object value) {
      ...
      final boolean bound = maybeBindLogical(preparedStatement, index, schema, value);
      if (!bound) {
        switch (schema.type()) {
          case INT8:
